    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-header">
                <p class="card-title float-end">Entladestellen</p>
            </div>
            <div class="card-body">
                    ...
                    <div class="accordion-item border-0 border-bottom p-2">
                        ...
                        <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse"
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Entladestelle</h4>
                                        <form class="form-sample" method="post" enctype="multipart/form-data"
                                            action="class/action.php">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 p-0 col-form-label">Platzname</label>
                                                        <div class="col-sm-9 p-0">
                                                            <input name="Platz" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9 p-0">
                                                            <select name="abteilung" class="form-control" required>
                                                                ...
                                                                <?php foreach($werkdata as $arrays):?>
                                                                <?php foreach($arrays['Deparments'] as $array):?>
                                                                <option
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 p-0 col-form-label">Video</label>
                                                        <div class="col-sm-9 p-0">
                                            ...
                                            <div class="row justify-content-end">
                                                <div class="col-12 text-end">
                                                    <input type="hidden" name="add_unloadplace" value="new">
                                                    <button type="submit"
                            ...
                            <div class="accordion-body">
                                <div class="table-responsive">
                                    <table class="table customized">
                                        ...
                                        <tbody>
                                            <?php $lf=1;foreach($unloadStellen as $id=>$stelle):?>
                                            <tr>
                                                <td class="align-middle"><?=$lf?></td>
                                                <td class="align-middle"><?=$stelle['Platz']?></td>
                                                <td class="align-middle"><?=$stelle['abteilung']?></td>
                                                <td class="align-middle"><?=$stelle['Video']?></td>

                                                <td>
                                                    <div class="row">
                                                        <div class="col-6 p-0">
                                                            <a href="entladestellen:<?=$stelle['Platz']?>:<?=$id?>"
                                                                data-bs-toggle="modal" data-bs-target="#editModal"
                                                                class="btn btn-light border p-2 open-edit-modal"><i
                                                                    class="ti-pencil"></i></a>
                                                        </div>
                                                        <div class="col-6 p-0">
                                                            <a href="class/action.php?p=entladestellen&deletedata=<?=$stelle['Platz']?>"
