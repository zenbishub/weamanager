...
a.sInstance+"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"erste",sLast:"letzte",sNext:"nächste",sPrevious:"vorherige"},sEmptyTable:"No data available in table",sInfo:"zeige _START_ bis _END_ von _TOTAL_ Einträge",sInfoEmpty:"zeige 0 bis 0 von 0 Einträge",
sInfoFiltered:"(gefiltert von _MAX_ gesamt Einträge)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Zeige _MENU_ Einträge",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Suche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"keine Einträge gefunden"},oSearch:h.extend({},l.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
